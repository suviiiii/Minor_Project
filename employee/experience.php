...
<head>
	...
	<title>Online job seeker  - Experience</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="../">Online job seeker </a></li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								?>
								   ...
								   <div class="col-sm-6 col-md-6">
							        ...
							        <div class="form-group"> 
								    <label>Total Years of Experience till Now <b style="color:#990000">*</b></label>
								    <input class="form-control" placeholder="Years" type="number" name="years" required> 
							        </div>
